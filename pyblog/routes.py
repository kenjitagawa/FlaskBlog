...
from pyblog import app, db, bcrypt, mail
from pyblog.forms import (RegistrationForm,
                            LoginForm,  
                            UpdateAccForm, 
                            PostForm,
                            RequestResetForm,
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        # Populate form with previous information
...
If you did not request this password change, ignore this email.
"""
    mail.send(msg)
